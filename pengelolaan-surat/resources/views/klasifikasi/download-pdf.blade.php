...
<body>
    <div id="receipt">
        <div class="flex">
            ...
            <div class="isi">
            {{-- {{ $letter->content }} --}}
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut voluptatem, totam expedita dignissimos ipsum quia? Eligendi quam porro dolor unde reprehenderit quia voluptatibus quidem quo, fugit in, culpa odio aspernatur!
            </div>
            <div class="hadir">
                {{-- @php
                    $no = 1;
